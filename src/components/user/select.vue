  ...
  <div>
    ...
    <ClientOnly>
      <Listbox v-model="selectedUser">
        <div class="relative">
          ...
          >
            ...
            >
              <div class="relative">
                <div class="truncate px-4 py-3 text-base-300 mix-blend-difference">
                  Conta pessoal
                </div>
                <ListboxOption v-slot="{ active, selected }" key="profile" value="" as="template">
                  ...
                  >
                    ...
                    <span v-if="selected" class="absolute inset-y-0 right-0 flex items-center pr-3 text-nuxa">
      ...
      <template #fallback>
        ...
        >
          <span class="isloading block h-4 w-32 truncate rounded-md bg-base-300 font-semibold" />
          <span
