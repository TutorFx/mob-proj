...
const baseLabel =
  "absolute -translate-y-2 top-2 left-1 z-10 origin-[0] scale-75 cursor-text select-none px-2 text-sm peer-placeholder-shown:top-1/2 peer-placeholder-shown:scale-100 peer-focus:top-2 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:px-2 transition-all duration-500 bg-base-100/0 peer-focus:bg-base-100";
