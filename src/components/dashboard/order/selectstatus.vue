<template>
  <Listbox v-model="state">
    <div class="relative mt-1">
      ...
      >
        <ListboxOptions
          class="shadow-lg absolute z-50 mt-1 max-h-60 w-full overflow-auto rounded-md bg-base-200 py-1 text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
        >
          <ListboxOption
          ...
          >
            <li
              :class="[
                active ? 'bg-amber-100 text-amber-900' : 'text-base-content',
