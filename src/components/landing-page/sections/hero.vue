<template>
  ...
  >
    <h1
      class="font-display mx-auto max-w-4xl text-3xl font-medium tracking-tight text-slate-900 sm:text-7xl"
    >
      Crie seu site mas de uma&nbsp;<span
        ...
        >
          ...
          /></svg
        ><span class="relative">forma simples</span></span
      >&nbsp;agora.
    </h1>
    <p class="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
      A sua jornada para a criação do e-commerce dos seus sonhos começa aqui com
      o nuxa, um novo serviço de SAAS e-commerce que busca tornar a realidade da
      loja digital acessível para todos, independentemente de sua origem.
    </p>
    <div class="mt-10 flex justify-center gap-x-6">
      ...
      ><a
        ...
        >
          ...
          /></svg
        ><span class="ml-3">Assista um vídeo</span></a
      >
    </div>
    <div class="mt-36 lg:mt-44">
      <p class="font-display mx-auto max-w-2xl text-base text-slate-700">
        Queremos que qualquer pessoa, de qualquer lugar, possa fazer parte do
        mundo digital.<br />Por isso, criamos o
        <Icon name="Typoblack" class="w-10" /> para ser uma plataforma de
        comércio eletrônico intuitiva e fácil de usar que não exige experiência
        técnica prévia.
      </p>
      <p class="mx-auto mt-6 tracking-tight text-slate-700" />
    </div>
  </div>
</template>
