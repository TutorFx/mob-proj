<template>
  <label class="mb-3">
    ...
    <input
      v-model="modelValue.name" type="text" placeholder="Ex: Bancada de Mármore"
  ...
  <label class="mb-3">
    ...
    <ui-inputs-text-area
      v-model="modelValue.description" class="textarea textarea-bordered w-full"
  ...
  <label class="mb-3">
    ...
    <Money3Component
      v-model.number="modelValue.price" decimal="," thousands="." type="text" placeholder="Ex: R$ 8000,00"
      class="input input-bordered w-full" />
