    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="md:text-center">
        ...
        <p class="mt-4 text-lg text-slate-400">
          It doesn’t matter what size your business is, our software won’t work well
          for you.
        </p>
      </div>
      <div
      ...
      >
        <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
          ...
          <p class="font-display order-first text-5xl font-light tracking-tight text-white">
            $9
          </p>
          <ul role="list" class="order-last mt-10 flex flex-col gap-y-3 text-sm text-slate-200">
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Send 10 quotes and invoices</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Connect up to 2 bank accounts</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Track up to 15 expenses per month</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Manual payroll support</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Export up to 3 reports</span>
            </li>
          </ul><a
        ...
        <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
          ...
          <ul role="list" class="order-last mt-10 flex flex-col gap-y-3 text-sm text-slate-200">
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Send unlimited quotes and invoices</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Connect up to 15 bank accounts</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Track up to 200 expenses per month</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
            ...
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4"
              >Export up to 25 reports, including TPS</span>
            </li>
          </ul><a
            class="group mt-8 inline-flex items-center justify-center rounded-full px-4 py-2 text-sm text-white ring-1 ring-slate-700 hover:ring-slate-500 focus:outline-none focus-visible:outline-white active:text-slate-400 active:ring-slate-700"
