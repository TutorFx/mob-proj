<template>
  <section id="pricing" aria-label="Pricing" class="grid items-center bg-slate-900 px-6 py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="md:text-center">
        <h2 class="font-display text-3xl tracking-tight text-white sm:text-4xl"><span
            class="relative whitespace-nowrap"><svg
aria-hidden="true" viewBox="0 0 281 40"
              class="absolute left-0 top-1/2 h-[1em] w-full fill-blue-400" preserveAspectRatio="none">
              <path
fill-rule="evenodd" clip-rule="evenodd"
        ...
        <p class="mt-4 text-lg text-slate-400">It doesn’t matter what size your business is, our software won’t work well
          for you.</p>
      </div>
      <div
        ...
        <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
          <h3 class="font-display mt-5 text-lg text-white">Starter</h3>
          <p class="mt-2 text-base text-slate-400">Good for anyone who is self-employed and just getting started.</p>
          <p class="font-display order-first text-5xl font-light tracking-tight text-white">$9</p>
          <ul role="list" class="order-last mt-10 flex flex-col gap-y-3 text-sm text-slate-200">
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4">Send 10 quotes and invoices</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4">Connect up to 2 bank accounts</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4">Track up to 15 expenses per month</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4">Manual payroll support</span>
            </li>
            <li class="flex">
              <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
                class="ml-4">Export up to 3 reports</span>
            </li>
          </ul><a
        ...
        <section class="order-first flex flex-col rounded-3xl bg-blue-600 px-6 py-8 sm:px-8 lg:order-none">
          <h3 class="font-display mt-5 text-lg text-white">Small business</h3>
          <p class="mt-2 text-base text-white">Perfect for small / medium sized businesses.</p>
          <p class="font-display order-first text-5xl font-light tracking-tight text-white">$15</p>
          <ul role="list" class="order-last mt-10 flex flex-col gap-y-3 text-sm text-white">
            <li class="flex"><svg aria-hidden="true" class="h-6 w-6 flex-none fill-current stroke-current text-white">
                <path
...
cx="12" cy="12" r="8.25" fill="none" stroke-width="1.5" stroke-linecap="round"
        ...
        <section class="flex flex-col rounded-3xl px-6 sm:px-8 lg:py-8">
          <h3 class="font-display mt-5 text-lg text-white">Enterprise</h3>
          <p class="mt-2 text-base text-slate-400">For even the biggest enterprise companies.</p>
        <p class="font-display order-first text-5xl font-light tracking-tight text-white">$39</p>
        <ul role="list" class="order-last mt-10 flex flex-col gap-y-3 text-sm text-slate-200">
          <li class="flex">
            <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
              class="ml-4">Send unlimited quotes and invoices</span>
          </li>
          <li class="flex">
            <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
              class="ml-4">Connect up to 15 bank accounts</span>
          </li>
          <li class="flex">
            <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
              class="ml-4">Track up to 200 expenses per month</span>
          </li>
          <li class="flex">
            <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
              class="ml-4">Automated payroll support</span>
          </li>
          <li class="flex">
            <Icon name="ph:check-circle" class="h-6 w-6 flex-none fill-current stroke-current text-slate-400" /><span
              class="ml-4">Export up to 25 reports, including TPS</span>
          </li>
        </ul><a
          class="group mt-8 inline-flex items-center justify-center rounded-full px-4 py-2 text-sm text-white ring-1 ring-slate-700 hover:ring-slate-500 focus:outline-none focus-visible:outline-white active:text-slate-400 active:ring-slate-700"
