<template>
  <div class="grid grid-rows-[max-content_max-content_1fr]">
    <div class="not-prose relative overflow-hidden border-b border-base-300 bg-base-200">
      <div class="relative">
    ...
    <div class="border-b border-base-300 bg-base-200">
      <div class="p-3 py-2 md:p-6 md:py-3">
        <div class="group pointer-events-auto relative w-10 transition-all focus-within:w-64 md:w-32">
          <label
type="button" :class="{ 'grid-cols-[max-content_1fr]': focused }"
...
d="m19 19-3.5-3.5" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              ...
              <circle
cx="11" cy="11" r="6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round"></circle>
            </svg>
            <input
ref="input" v-model="searchInput" type="search"
              class="h-6 w-full border-0 border-none bg-transparent text-primary ring-0 focus:ring-0">
            <div v-if="!focused" class="ml-auto hidden w-16 grid-flow-col text-xs font-semibold md:grid">
    ...
    <div class="bg-base-200">
      <CheckoutAdminList v-if="statuses" v-model="selected" :status-list="statuses" />
    </div>
  </div>
</template>
